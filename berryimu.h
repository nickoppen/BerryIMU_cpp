...
//		}
		...
		//bool configureMag (mag_odr datarate, mag_resolution mag_resolution = M_HIGH_RES, bool temperature = true, bool latch_interrupt_on_int1_src = 0, bool latch_interrupt_on_int2_src = 0)
		//{
...
//		float m_last_temperature_reading = 0.;
	...
	public:
		...
		{
			return IMU::read (GYR, output, false); 
		}
	...
	public:
		...
		bool read(double* output)
		{
			return IMU::read (MAG, output, false); 
		}
