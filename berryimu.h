	...
	class IMU
	{
		...
		bool readRaw (sensor_type type, int16_t *output, bool reuse_device = false)
		{
			...
			*/
			...
			{
			case ACC:
				register_address |= OUT_X_L_A;
				break;
			case MAG:
				register_address |= OUT_X_L_M;
				break;
			case GYR:
				register_address |= OUT_X_L_G;
				break;
			case TP:
		...
		bool configureMag (mag_odr datarate, mag_resolution mag_resolution = M_HIGH_RES, bool temperature = true,
				   bool latch_interrupt_on_int1_src = 0, bool latch_interrupt_on_int2_src = 0)
		{
		...
		bool configureGyr (gyro_odr odr, gyr_power_mode pd = G_POWER_NORMAL, bool enableX = true, bool enableY = true,
				   bool enableZ = true)
		{
		...
		bool configureAcc (acc_odr datarate, acc_bdu bdu = A_CONTINUOUS_UPDATE, bool enableX = true, bool enableY = true,
				   bool enableZ = true)
		{
